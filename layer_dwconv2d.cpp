...
ocl::dwconv2d::dwconv2d(layer* p, int ks, int s, int pad, bool use_bias)
{
    name = "DW-Conv2D";
    useBias = use_bias;
    padSize = pad;
...
size_t ocl::dwconv2d::setParam(OCL_TYPE* buffer)
{
...
void ocl::dwconv2d::setKernel()
{
    kernel = ocl::createKernel(dProgram, "DWConv2D");
